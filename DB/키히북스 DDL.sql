...
CREATE TABLE `EPISODE` (
	`EP_CODE`	CHAR(12) PRIMARY KEY	NOT NULL,
...
CREATE TABLE `ORDER_LIST` (
	`OL_NUM`	INT PRIMARY KEY AUTO_INCREMENT	NOT NULL,
	`OL_EP_CODE`	CHAR(12)	NULL,
	`OL_OD_NUM`	INT	NOT NULL
);
